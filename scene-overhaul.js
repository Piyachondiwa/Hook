/* Moonwood scene overhaul: elevated 3/4 feel + Japanese rural island + bridge. */
(()=>{
'use strict';
...
function pixelTree(x,y,s=1){B(x-4*s,y-2*s,8*s,28*s,C.wood);B(x-2*s,y,4*s,24*s,C.wood2);B(x-24*s,y-18*s,48*s,22*s,C.bamboo);B(x-17*s,y-29*s,34*s,17*s,C.bamboo);B(x-8*s,y-39*s,17*s,14*s,C.bamboo);B(x-20*s,y-12*s,11*s,6*s,C.sakura);B(x+8*s,y-20*s,10*s,6*s,C.sakura2);B(x-7*s,y-34*s,8*s,6*s,C.sakura2)}
function house(x,y,s=1,roof=C.roof){B(x,y,112*s,72*s,C.wall);B(x+7*s,y+10*s,98*s,62*s,C.wall2);B(x-8*s,y-8*s,128*s,12*s,roof);B(x+5*s,y-17*s,102*s,10*s,C.roof2);B(x+17*s,y-24*s,78*s,9*s,roof);for(let i=0;i<7;i++)B(x+(i*16-4)*s,y-7*s,2*s,10*s,C.dark);B(x+13*s,y+19*s,32*s,27*s,C.dark);B(x+17*s,y+23*s,24*s,19*s,C.paper);B(x+53*s,y+19*s,42*s,27*s,C.dark);B(x+57*s,y+23*s,34*s,19*s,C.paper);B(x+5*s,y+49*s,101*s,5*s,C.dark);B(x+47*s,y+50*s,14*s,22*s,C.dark);B(x+50*s,y+54*s,8*s,18*s,C.wood2);B(x-2*s,y-5*s,116*s,4*s,C.wood)}
function torii(x,y,s=1){B(x-55*s,y-56*s,8*s,72*s,C.red);B(x+47*s,y-56*s,8*s,72*s,C.red);B(x-68*s,y-67*s,136*s,9*s,C.red);B(x-57*s,y-77*s,114*s,8*s,C.red2);B(x-42*s,y-49*s,84*s,7*s,C.red2);B(x-5*s,y-49*s,10*s,48*s,C.red)}
function lantern(x,y){B(x-2,y,4,22,C.dark);B(x-8,y-7,16,10,C.stone);B(x-5,y-13,10,7,C.stone2);B(x-4,y-5,8,7,C.lantern);B(x-5,y+22,10,3,C.dark)}
...
function island(){
 ...
 torii(2970,1035,1);lantern(2895,1050);lantern(3045,1050);B(2925,1055,90,35,C.stone);B(2935,1048,70,8,C.stone2);
