/* Moonwood bridge hitbox fix: one authoritative walk corridor with explicit edge barriers. */
(()=>{'use strict';
...
window.moonwoodBridgeFix={active:true,authoritative:true,corridor:{...CORRIDOR},bridge:{...BRIDGE},northBarrier:CORRIDOR.y1,southBarrier:CORRIDOR.y2};
})();
